...
module.exports = {
  connect: function () {
    logger.info({
      coreConnectionString: config.get('Hoist.mongo.core.connectionString'),
      overlordConnectionString: config.get('Hoist.mongo.overlord')
    }, 'connecting overlord connection and core connection');
